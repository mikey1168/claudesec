...
- **Source**: https://github.com/sahar042/offensive-checklist/blob/main/Low-level%20Keylogger%20architecture_.md
...
- **AMSI/Defender Evasion**: String obfuscation, memory patching, and using undocumented APIs.
- **Living Off the Land (LOLBins)**: Rely on native Windows binaries (`wmic`, `powershell`, `certutil`) to blend in with normal administrative traffic.
