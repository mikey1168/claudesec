...
- **Source**: https://github.com/sahar042/offensive-checklist/blob/main/Advanced%20red-team%20operations%20for%20dummies.md
...
- **Direct Syscalls**: Use SysWhispers to bypass user-land API hooks (e.g., `NtAllocateVirtualMemory`).
- **Sleep Obfuscation**: Implement custom sleep functions (e.g., Ekko, Foliage) to evade memory scanners during sleep cycles.
- **Module Stomping**: Inject shellcode into legitimately loaded, but unused, DLLs in memory.
