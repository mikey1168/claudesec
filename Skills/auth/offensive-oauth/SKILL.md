...
- **Source**: https://github.com/sahar042/offensive-checklist/blob/main/oauth.md
...
- **State Parameter Hijacking**: If `state` is not tied to the user session, inject your own session's `state`.
