...
- **Source**: https://github.com/sahar042/offensive-checklist/blob/main/ssrf.md
...
- **IP Obfuscation (Metadata)**:
  - Decimal: `http://2852039166` (169.254.169.254)
  - Octal: `http://0251.0376.0251.0376`
  - Hex: `http://0xA9.0xFE.0xA9.0xFE`
- **DNS Rebinding**: Use services like `rbndr.us` to map a domain to an external IP, then rapidly change it to `127.0.0.1` after validation.
