...
- **Source**: https://github.com/sahar042/offensive-checklist/blob/main/parameter-pollution.md
...
- **WAF Chunking**: Use `Transfer-Encoding: chunked` to break up malicious payloads.
- **Encoding Bypasses**: URL encoding, Hex encoding, or Unicode normalization abuses.
- **Header Obfuscation**: Inject payload in obscure headers like `X-Forwarded-For` or `True-Client-IP`.
