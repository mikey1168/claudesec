...
- **Source**: https://github.com/sahar042/offensive-checklist/blob/main/file-upload.md
...
- **Magic Bytes Bypass**: Prepend `GIF89a;` or `ÿØÿ` to the start of the file.
- **Double Extensions**: `shell.php.jpg` or `shell.jpg.php`
- **Null Byte Injection**: `shell.php%00.jpg`
- **Alternative PHP Extensions**: `.php3`, `.php4`, `.php5`, `.phtml`, `.phar`
