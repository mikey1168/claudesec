...
- **Source**: https://github.com/sahar042/offensive-checklist/blob/main/idor.md
...
- **Parameter Array Wrapping**: `id[]=1` or `{"id":[1]}`
- **Wildcard Injection**: `id=*` or `id=%`
- **Parameter Pollution**: `?id=1&id=2` (Backend processes the second, WAF checks the first)
- **JSON Type Confusion**: `{"id": "1"}` vs `{"id": 1}`
